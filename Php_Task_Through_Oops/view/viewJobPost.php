...
<body class="bg-muted">
    ...
    <div class="container-fluid bg-muted p-0">
        ...
        <div class="div2 p-3">
            ...
            <form method="post" action="../controller/conJobPost.php?id=<?php echo $id;?>" enctype="multipart/form-data" onsubmit="return cnfForm()">
            ...
            <div class="form-content">
                ...
                <br><input type="text" name="email" value="<?php echo $mail;?>" class="inp" id="emailVal" >              
                <br>
            </div>
            ...
            <span class="para1" >Location:</span> 
                ...
                <br><input type="text" name="location" value="<?php echo $website;?>" class="inp" id="locVal">
                <br>
            </div>
            ...
            <span class="para1" >Job Title:</span> 
               <span class="error req-fd" id="titleHint">*
                ...
                <br><textarea name="title" rows="5" cols="40" class="inp1" id="titleVal"><?php echo $comment;?></textarea>
                <br>
            </div>
