<?php 
    ...
    $sql = "SELECT * FROM postedjob WHERE sr='$id' ";
...
<body class="bg-muted">
    ...
    <div class="container-fluid bg-muted p-0">
            ...
            <div class="col-lg-12 p-0">
                <nav class="navbar nav1 ">
                    <div class="div1">
                        ...
                        <div class="child2">
                            <a href="http://localhost/html/Php_Task_Through_Oops/view/viewUserPostedJobs.php?id=<?php echo $sr;?> & mail=<?php echo $row['email'];?>" class="link1">User Profile</a>
        ...
        <div class="div2 p-3">
            ...
            <form method="post" action="../controller/conUpdateJobs.php?sr=<?php echo $sr;?> & id=<?php echo $row["sr"];?>" enctype="multipart/form-data" onsubmit="return cnfForm()">
