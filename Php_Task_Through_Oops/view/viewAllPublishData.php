...
<body class="">   
  <div class="body">    
    ...
    <div class="row m-5">
      ...
      <div class="col-lg-8">
           <div class="m-link">
           <div class="btm-para">Users all publish posts.</div>
           </div>   
      </div>
      <div class="col-lg-2 ">
          <div class="f-link s-link">
           <a href="../controller/.php?id=<?php echo $id;?> & mail=<?php echo $mail;?>" class="btn-a" onclick="return alldel()">All Delete</a>
           </div>              
      </div>
    </div>
    ...
    <div class="div2 ">
    <form method="POST" action="../controller/.php?id=<?php echo $id;?> & mail=<?php echo $mail;?>">
      ...
      <table class="table1 table2" border="1" cellSpacing="0" >
        <tbody>
          <tr height="">
            ...
            <td width="15%">
                <a href="../controller/.php?sr=<?php echo $row['sr'];?> & id=<?php echo $id;?> & mail=<?php echo $mail;?>" class="delete" onclick="return cnfDelete();"><i class="fa-solid fa-trash"></i></a>
                <a href=".php?sr=<?php echo $row['sr'];?> & id=<?php echo $id;?> & mail=<?php echo $mail;?>" class="update" onclick="return cnfEdit();"><i class="fa-solid fa-pen" ></i></a>
            </td>
          </tr>
        </tbody>
        </table>
        ...
        <?php
          ...
          if($page>1){
                echo '<li class="pgn-ul pgn-li"><a href="http://localhost/html/Php_Task_Through_Oops/view/viewAllPublishData.php?page='.($page -1).' & id='.$id.' & mail='.$mail.'" class="text-decoration-none text-light">Prev</a></li>';
          }
          for($i=1;$i<=$total_page;$i++){
              ...
              echo '<li class="pgn-ul pgn-li '.$active.'"><a href="http://localhost/html/Php_Task_Through_Oops/view/viewAllPublishData.php?page='.$i.' & id='.$id.' & mail='.$mail.'" class="text-decoration-none text-light">'.$i.'</a></li>';
          }
          if($total_page >$page){
              echo '<li class="pgn-ul pgn-li"><a href="http://localhost/html/Php_Task_Through_Oops/view/viewAllPublishData.php?page='.($page +1).' & id='.$id.' & mail='.$mail.'" class="text-decoration-none text-light">Next</a></li>';
          }
          echo '</ul>';
          }
        ?>
